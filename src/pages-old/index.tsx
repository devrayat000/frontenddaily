...
import { FRAMEWORKS_QUERY } from "~/components/home/FilterDrawer/query";
...
export const getServerSideProps = async (ctx: GetServerSidePropsContext) => {
  ...
  await client
    .query<FrameworksQuery, FrameworksQueryVariables>(FRAMEWORKS_QUERY, {})
    .toPromise();
  ...
  await client
    .query<ProjectsQuery, ProjectsQueryVariables>(
      PROJECTS_QUERY,
      {
        where: {
          frameworks_some: {
            name: framework !== "all" ? (framework as string) : undefined,
          },
