...
export type ProjectCreateInput = {
  ...
  tags?: InputMaybe<ProjecttagsUnionCreateManyInlineInput>;
  title: Scalars['String'];
  updatedAt?: InputMaybe<Scalars['DateTime']>;
};
...
export type ProjectUpdateInput = {
  ...
  slug?: InputMaybe<Scalars['String']>;
  sourceCode?: InputMaybe<Scalars['String']>;
  tags?: InputMaybe<ProjecttagsUnionUpdateManyInlineInput>;
  title?: InputMaybe<Scalars['String']>;
};
...
export type ProjecttagsUnion = Tag;

export type ProjecttagsUnionConnectInput = {
  Tag?: InputMaybe<TagConnectInput>;
};

export type ProjecttagsUnionCreateInput = {
  Tag?: InputMaybe<TagCreateInput>;
};

export type ProjecttagsUnionCreateManyInlineInput = {
  /** Create and connect multiple existing ProjecttagsUnion documents */
  create?: InputMaybe<Array<ProjecttagsUnionCreateInput>>;
};

export type ProjecttagsUnionCreateOneInlineInput = {
  /** Create and connect one ProjecttagsUnion document */
  create?: InputMaybe<ProjecttagsUnionCreateInput>;
};

export type ProjecttagsUnionCreateWithPositionInput = {
  Tag?: InputMaybe<TagCreateWithPositionInput>;
};

export type ProjecttagsUnionUpdateInput = {
  Tag?: InputMaybe<TagUpdateInput>;
};

export type ProjecttagsUnionUpdateManyInlineInput = {
  /** Create and connect multiple ProjecttagsUnion component instances */
  create?: InputMaybe<Array<ProjecttagsUnionCreateWithPositionInput>>;
  /** Delete multiple ProjecttagsUnion documents */
  delete?: InputMaybe<Array<ProjecttagsUnionWhereUniqueInput>>;
  /** Update multiple ProjecttagsUnion component instances */
  update?: InputMaybe<Array<ProjecttagsUnionUpdateWithNestedWhereUniqueAndPositionInput>>;
  /** Upsert multiple ProjecttagsUnion component instances */
  upsert?: InputMaybe<Array<ProjecttagsUnionUpsertWithNestedWhereUniqueAndPositionInput>>;
};

export type ProjecttagsUnionUpdateManyWithNestedWhereInput = {
  Tag?: InputMaybe<TagUpdateManyWithNestedWhereInput>;
};

export type ProjecttagsUnionUpdateOneInlineInput = {
  /** Create and connect one ProjecttagsUnion document */
  create?: InputMaybe<ProjecttagsUnionCreateInput>;
  /** Delete currently connected ProjecttagsUnion document */
  delete?: InputMaybe<Scalars['Boolean']>;
  /** Update single ProjecttagsUnion document */
  update?: InputMaybe<ProjecttagsUnionUpdateWithNestedWhereUniqueInput>;
  /** Upsert single ProjecttagsUnion document */
  upsert?: InputMaybe<ProjecttagsUnionUpsertWithNestedWhereUniqueInput>;
};

export type ProjecttagsUnionUpdateWithNestedWhereUniqueAndPositionInput = {
  Tag?: InputMaybe<TagUpdateWithNestedWhereUniqueAndPositionInput>;
};

export type ProjecttagsUnionUpdateWithNestedWhereUniqueInput = {
  Tag?: InputMaybe<TagUpdateWithNestedWhereUniqueInput>;
};

export type ProjecttagsUnionUpsertWithNestedWhereUniqueAndPositionInput = {
  Tag?: InputMaybe<TagUpsertWithNestedWhereUniqueAndPositionInput>;
};

export type ProjecttagsUnionUpsertWithNestedWhereUniqueInput = {
  Tag?: InputMaybe<TagUpsertWithNestedWhereUniqueInput>;
};

export type ProjecttagsUnionWhereInput = {
  Tag?: InputMaybe<TagWhereInput>;
};

export type ProjecttagsUnionWhereUniqueInput = {
...
export type ProjectQuery = { __typename?: 'Query', project?: { __typename?: 'Project', id: string, title: string, framework: Framework, sourceCode?: string | null, preview?: string | null, publishedAt?: any | null, image: { __typename?: 'Asset', id: string, height?: number | null, width?: number | null, url: string }, description?: { __typename?: 'RichText', raw: any, markdown: string } | null, tags: Array<{ __typename?: 'Tag', id: string, name: string, slug: string }> } | null };
...
export type ProjectsQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', id: string, title: string, slug: string, framework: Framework, preview?: string | null, publishedAt?: any | null, image: { __typename?: 'Asset', id: string, height?: number | null, width?: number | null, url: string } }> };
