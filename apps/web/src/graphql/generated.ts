...
export type AboutMeQuery = { __typename?: 'Query', about?: { __typename?: 'About', content: { __typename?: 'Portfolio_AboutContentRichText', raw: any } } | null };

export type SimpleProjectFragment = { __typename?: 'Project', id: string, title: string, slug: string, framework: Framework, createdAt: any, image: { __typename?: 'Asset', id: string, url: string } };
...
export function usePreviewQuery(options: Omit<Urql.UseQueryArgs<PreviewQueryVariables>, 'query'>) {
  return Urql.useQuery<PreviewQuery, PreviewQueryVariables>({ query: PreviewDocument, ...options });
};
export const ProjectsDocument = gql`
    query Projects($after: String, $before: String, $first: Int, $last: Int, $skip: Int, $where: ProjectWhereInput) {
  projects(
    after: $after
    before: $before
    first: $first
